...
2)02. JAR-приложения для многопоточной загрузки -**work2**

3)03. Реализлвать Maven-проект для многопоточной загрузки -**work2maven + work2mavenLib**

4)04. Реализовать SimpleJdbcTemplate - Находится в **Semester_Work** в **repository/utill**  ссылка  -    
...
5)05. Логирование и примитивная безопасность - Всё в **Semester_Work**
...
6)PasswordEncoder feat. HttpSession - Всё в **Semester_Work**
...
7)07. Реализовать EntityManager - находится в  **work3Reflection**
...
9)09. Sockets  находится в : **simple-char-902-v2-LegendaryZer0**

10)10. Сделать AnnotationProcessing находится в  - **15.Annotations_SOURCE**
